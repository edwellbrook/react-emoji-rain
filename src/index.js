...
class EmojiRain extends React.Component {
  ...
  constructor() {
    ...
    this.__generator = this.__fromCodePoint;
  }
  ...
  componentDidMount() {
    ...
    if (typeof this.props.generator !== 'undefined') {
      this.__generator = this.props.generator;
    }
  ...
  __paintEmoji(opts) {
    ...
    const font = (() => {
      ...
      return isEven ? '20px serif' : '30px serif';
    })();
   ...
   */
  __fromCodePoint() {
    const codepoint = this.__emoji[Math.floor((Math.random() * this.__totalEmoji))];
  ...
  giveMeARandomEmoji() {
    ...
    emoji.char = this.__generator(emoji.code);
